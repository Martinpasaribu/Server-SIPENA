...
EmployeeRouter.post("/", VerifyAdminId_1.verifyAdmin, employee_controllers_1.EmployeeController.CreateEmployee);
...
EmployeeRouter.patch("/update/:_id", employee_controllers_1.EmployeeController.UpdateEmployeeClient);
